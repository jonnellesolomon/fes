  ...
  <main class="" id="login-main">
    <div class="container-fluid mt-5">
       ...
       <div id="login-left" class="row align-items-center justify-content-center">
                <h2 style="color: white; text-align: center; font-family: 'montserrat';">Faculty Evaluation <br> Wesleyan University-Philippines</h2>
       </div>
                    ...
                    <div class="card-body card-body-cascade">
                        <div class="container-fluid">
                            ...
                            <form action="" id="login-frm">
                                ...
                                <button style="font-size:20px;" class="btn btn-sm btn-primary btn-block">Login</button>
